...
🔹 Tools: Power BI, Data Modeling, ETL, Data Cleaning, CSV.`,
  ...
  const portfolioProject = {
    ...
    description:
      "Designed and developed a responsive personal portfolio website to showcase my professional profile, technical skills, services, certifications, and data analysis projects. The website integrates interactive UI components, project galleries, external project links, video presentations, CV download, and direct contact options.",
    role:
      "Designed and developed the website from scratch, structured the content into reusable components, implemented responsive layouts and interactive animations, and integrated external assets and links.",
    technologies: [
      "React",
      "JavaScript",
      "Tailwind CSS",
    ...
    features: [
      ...
      "Projects with images and video links",
      "CV download and LinkedIn integration",
      "WhatsApp and email contact options",
      "Certifications section with direct certificate access",
      "Hosted online using Vercel",
    ],
    result:
      "A professional, responsive portfolio website that provides a clear and interactive presentation of my technical background, projects, and services.",
  };
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-black text-zinc-900 dark:text-zinc-100">
      ...
      {page === "edu-exp" && (
        ...
        >
          ...
          <Card>
            ...
            <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x dark:divide-zinc-700">
              ...
              <div className="pt-6 md:pt-0 md:pl-8">
                ...
                <div className="mt-3 text-sm text-muted-foreground space-y-5 leading-7">
                  <div>
                    <p className="font-medium text-zinc-900 dark:text-zinc-100">
                      Digital Egypt Pioneers Initiative (DEPI)
                    </p>
                    <p>Round 3 – Data Analysis Specialist · Completed</p>
                    <ul className="mt-2 space-y-2 list-disc list-inside">
                      <li>Gained hands-on experience in data cleaning, exploratory data analysis, data visualization, and business intelligence.</li>
                      <li>Collected, cleaned, and analyzed real-world datasets using Power BI and Excel.</li>
                      <li>Built and delivered interactive dashboards to support data-driven decision making.</li>
                      <li>Collaborated in solving 20+ practical data challenges through team-based problem solving.</li>
                      <li>Strengthened decision-making, teamwork, and attention to detail through remote collaborative work.</li>
                    </ul>
                  </div>
                  ...
                  <div className="border-t pt-5 dark:border-zinc-700">
                    ...
                    <ul className="mt-2 space-y-2 list-disc list-inside">
                      <li>Currently participating in the Full-Stack .NET Track and developing practical software development skills.</li>
                      <li>Building skills in C#, .NET, ASP.NET Core Web API, ASP.NET Core MVC, SQL Server, and modern web technologies.</li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-8">
          ...
          <button
            type="button"
            onClick={() => setProjectCategory("portfolio")}
            className={`px-5 py-3 rounded-xl font-medium shadow-sm transition-all ${
        ...
        {projectCategory === "portfolio" && (
          ...
          <Card>
            <h3 className="text-xl font-semibold">{portfolioProject.name}</h3>
            ...
            <div className="mt-6 space-y-6">
              ...
              <div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {portfolioProject.technologies.map((technology) => (
              ...
              <div>
                ...
                <ul className="mt-3 space-y-2 text-sm text-muted-foreground list-disc list-inside leading-6">
